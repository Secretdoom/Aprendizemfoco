...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Caça-Palavras Específico (Corrigido o Grid CSS e adicionado !important) */
        .word-search-grid {
            display: grid !important; /* Garantir que o display grid seja aplicado */
            grid-template-columns: repeat(18, 25px) !important; /* Garantir as colunas */
            grid-template-rows: repeat(12, 25px) !important; /* Garantir as linhas */
            gap: 1px; 
        ...
        /* Sudoku Específico (Adicionado !important para display grid) */
        .sudoku-grid {
            display: grid !important; /* Garantir que o display grid seja aplicado */
            grid-template-columns: repeat(9, 35px) !important; /* Garantir as colunas */
            grid-template-rows: repeat(9, 35px) !important; /* Garantir as linhas */
        ...
        @media (max-width: 768px) {
            ...
            .word-search-grid { grid-template-columns: repeat(18, 18px) !important; grid-template-rows: repeat(12, 18px) !important; }
            .word-search-cell { width: 18px; height: 18px; font-size: 0.7em; }
            .sudoku-grid { grid-template-columns: repeat(9, 30px) !important; grid-template-rows: repeat(9, 30px) !important; }
